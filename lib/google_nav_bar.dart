    ...
    return Container(
        // padding: EdgeInsets.all(12),
          ...
          child: Row(
            ...
            children: widget.tabs.map((t) => GButton(
...
class GButton extends StatefulWidget {
  ...
  GButton({Key key, this.active, this.color, this.icon, this.iconColor, this.iconActiveColor, this.text, this.textColor, this.padding, this.gap, this.textStyle, this.iconSize, this.onPressed});
...
class _GButtonState extends State<GButton> {
  ...
  Widget build(BuildContext context) {
    return Button(
                ...
                gap: widget.gap,
                color: widget.color,
                icon: Icon(widget.icon, color: widget.active ? widget.iconActiveColor : widget.iconColor),
                text: Text(
                  widget.text,
...
class Button extends StatefulWidget {
  Button({Key key, this.icon, this.text, this.gap = 0, this.color, this.onPressed, this.padding = const EdgeInsets.all(25), this.margin = const EdgeInsets.all(0), this.active = false}) : super(key: key);
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            color: _expanded ? Colors.transparent :widget.color,
                  ...
                  children: <Widget>[
                    SizeTransition(
                      ...
                      child: AnimatedOpacity(
                        ...
                        curve: _expanded ? Curves.easeOutExpo: Curves.easeInQuad,
